...
let MyalarmsPage = class MyalarmsPage {
    ...
    getAlarmList() {
        this.http.get('/list_all_alarm').subscribe((response) => {
        }, (error) => {
            console.log(error);
        });
    }
                    ...
                    },
                    {
                        ...
                        handler: () => {
                            ...
                            if (this.storeAlram == true) {
                                this.http.post('/delete_store_alarm', obj).subscribe((response) => {
                                ...
                                this.http.post('/delete_alarm_product', obj).subscribe((response) => {
                                    console.log(response);
                                    if (response.success == "true") {
                                        const Toast = sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().mixin({
                                            toast: true,
    ...
    getproductAlarmList() {
        this.http.get('/product_read_alarm').subscribe((response) => {
...
MyalarmsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([

  ...
  (self["webpackChunk_24HrsUserApp"] = self["webpackChunk_24HrsUserApp"] || []).push([["src_app_signin_signin_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SigninPage = /*#__PURE__*/function () {
        function SigninPage(router, http, toastCtrl) {
        ...
        _createClass(SigninPage, [{
          ...
          value: function countDown() {
            ...
            this.intervalId = window.setInterval(function () {
              ...
              if (_this.seconds === 0) {// this.message = 'Offers Ends..!';
              } else {
                if (_this.seconds < 0) {
                  _this.seconds = 60;
                } // reset
                ...
                _this.message = "".concat(_this.hour, ". ").concat(_this.seconds, "s");
              }
            }, 1000);
          }
        }, {
          ...
          value: function signin() {
            ...
            this.http.post('/user_login', Data).subscribe(function (response) {
              if (response.success == "true") {
                ...
                _this2.loginsts = response.user_status;
                console.log(obj);

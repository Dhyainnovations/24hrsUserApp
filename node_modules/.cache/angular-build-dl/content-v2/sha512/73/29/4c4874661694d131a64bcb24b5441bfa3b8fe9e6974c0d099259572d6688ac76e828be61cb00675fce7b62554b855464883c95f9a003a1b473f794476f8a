(function () {
  ...
  (self["webpackChunk_24HrsUserApp"] = self["webpackChunk_24HrsUserApp"] || []).push([["src_app_setalarm_setalarm_module_ts"], {
    /***/
    30385:
    /*!*****************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SetalarmPage = /*#__PURE__*/function () {
        ...
        _createClass(SetalarmPage, [{
          ...
          key: "selectStoreForProductSetAlarm",
          value: function selectStoreForProductSetAlarm() {
            var _this2 = this;

            this.isVisible = true;
            this.storeIdUseOfProductSetAlarm = name; // var formData = new FormData();
            ...
            this.http.post('/product_list', obj).subscribe(function (response) {
              console.log(response);
              _this2.productNameList = response.records;
            }, function (error) {
              console.log(error);
            });
          }
        }, {
          key: "setAlarmForProduct",
          value: function setAlarmForProduct() {
            var _this3 = this;
            ...
            console.log(obj);
            this.http.post('/product_alarm', obj).subscribe(function (response) {
              console.log(response);

              if (response.success == "true") {
                _this3.selectProductName = '';
          ...
          key: "selectProductToSetAlarm",
          value: function selectProductToSetAlarm(name) {
            var _this4 = this;
            ...
            this.http.get('/product_search_user?s=' + s).subscribe(function (response) {
              if (response.success == "true") {
                ...
                _this4.weight = response.records.weight;
                _this4.unit = response.records.unit;
                _this4.totalCost = response.records.total_cost;
                _this4.offerPrice = response.records.offer_price;
                _this4.productTbid = response.records.tbid;
                _this4.isVisibleForProduct = false;
                _this4.resultProductCardVisible = true;
              }
            }, function (error) {
              console.log(error);
            });
          ...
          value: function storeList() {
            ...
            this.http.get('/list_store').subscribe(function (response) {
              console.log(response);
              _this5.getStoreList = response.records;
              console.log(response.records);
              console.log(_this5.getStoreList);
            }, function (error) {
              console.log(error);
            });
          }
          ...
          key: "selectStoreForGetStoreDetails",
          value: function selectStoreForGetStoreDetails(tbid, name) {
            var _this6 = this;
            ...
            this.http.post('/store_details_user', obj).subscribe(function (response) {
              ...
              if (response.success == "true") {
                _this6.resultStoreCardVisible = true;
                _this6.storeLogForStore = response.records.store_logo;
                _this6.storeNameForSrore = response.records.store_name;
              }
            }, function (error) {
              console.log(error);
            });
          ...
          key: "setAlarmForStore",
          value: function setAlarmForStore() {
            var _this7 = this;
            ...
            console.log(obj);
            this.http.post('/store_alarm', obj).subscribe(function (response) {
              console.log(response);
          ...
          value: function searchProduct() {
            ...
            this.http.post('/product_list', obj).subscribe(function (response) {
              console.log(response);
              _this8.getProductList = response.records;
              console.log(response.records);
              console.log(_this8.getStoreList);
            }, function (error) {
              console.log(error);
            });
          }
        }, {
          key: "productSearchBasedOnStore",
          value: function productSearchBasedOnStore() {
      ...
      _SetalarmPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
